...
// Replay Parser Performance
const replayParseDuration = new client.Histogram({
    name: 'replay_parse_duration_seconds',
    help: 'Latency of replay parsing operations',
    buckets: [0.5, 1, 2, 5, 10, 20]
});
register.registerMetric(replayParseDuration);

// Credit Transaction Ticker
const creditUsageCounter = new client.Counter({
    name: 'credit_usage_total',
    help: 'Total number of credits consumed across all keys',
