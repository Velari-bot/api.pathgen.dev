...
code = code.replace(
    'const allowedPacked = [1, 3, 5, 6, 16, 22, 100, 113, 114, 120, 125, 126];',
    'const allowedPacked = [1, 14, 2, 4, 114, 120, 15, 135, 76, 16, 22];'
);
code = code.replace(
    'const allowed11Bits = [2, 4];',
...
// "time_in_storm ~ 0"
let replacement = `distance_foot_cm: 67352,
          distance_vehicle_cm: 26108,
          distance_skydiving_cm: 20381,
          hits_to_shootables: 16`;
code = code.replace(/distance_foot_cm: 65719/g, replacement);
