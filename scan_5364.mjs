...
const req = [42, 242, 31, 496, 207, 5, 0, 13, 146, 210, 1, 2];
const d = { p: {}, b11: {} };
       ...
       for(let i=0; i<Math.min(sz-32, 1000); i++) {
           try {
               ...
               if (h > 0 && h < 200) {
                   const pBak = s.p;
                   const vP = s.rP();
                   if (req.includes(vP) && vP <= 2000000) d.p[h] = vP;
                   s.p = pBak; const v11 = s.rBs(11);
                   if (req.includes(v11) && v11 <= 2047) d.b11[h] = v11;
               }
           } catch(x){}
       }
   }
...
console.log("CH 5364 matches:");
console.log("Packed: ", d.p);
console.log("Bits11: ", d.b11);
